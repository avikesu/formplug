...
export default function Home() {
  return (
    <div className="container pt-4">
      ...
      <h2 className="text-2xl font-bold col-span-2">Recent Forms</h2>
      <Separator className="my-8" />
...
function FormCard({ form }: { form: Form }) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2 justify-between min-w-0">
        ...
        <CardDescription className="flex items-center justify-between text-muted-foreground text-sm">
          ...
          {form.published && (
            <span className="flex items-center gap-2">
              ...
              <FaWpforms className="text-muted-foreground ml-4" />
      ...
      <CardContent className="h-5 truncate text-sm text-muted-foreground">
        {form.description
          ? form.description
          : "No description provided for this form."}
      </CardContent>
      <CardFooter>
        {form.published && (
